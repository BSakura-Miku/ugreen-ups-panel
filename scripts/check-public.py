...
FILES = (
    ...
    'Dockerfile', 'docker-compose.yaml', 'compose.build.yaml', 'compose.updater.yaml', 'requirements.txt', 'requirements.lock', 'requirements-dev.txt',
    ...
    'docs/validation.md', 'docs/STORAGE.md', 'docs/battery-observation.md', 'docs/battery-capacity.md', 'docs/energy-usage.md', 'docs/diagnostics.md', 'docs/collector-update.md', 'docs/assets/dashboard-demo.png',
    ...
    'scripts/updater-admin.py', 'scripts/install-updater.sh', 'scripts/uninstall-updater.sh', 'scripts/package-collector.py',
